...
if __name__ == '__main__':        
    ...
    # would the branching/jump statements work?   How would call
    # the function from other code such as a loop like this?
    #
    #    n = 1
    #    while n <= 10:
    #        print(fact(n))
    ...
    # register.
    #
    # Your solution should be organized in a manner where the outer
    # loop that counts to 10 and the fact function are separate bits
    # of code.  The function part needs to be a self-contained unit of
    # code that gets inputs, calculates the factorial value, and
    # returns the result back to the caller.  The fact function should
    # be reusable in the sense that it can be "called" from anywhere
    # whenever a factorial value is needed.
    # 

    prog3 = [
        # Print out the first 10 factorials
        ('CONST', 1, 'R1'),       # n = 1

        # while n <= 10:
        #     print(fact(n))      # Call the fact function below
        #     n += 1
        #
        # ... instructions here
        # 
    ...
    # Label: fact
        ('CONST', 1, 'R2'),       # First instruction of fact
        # ...
        ('JMP', ...),             # Last instruction of fact. Jumps back to the caller
